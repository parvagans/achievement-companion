...
STEAMOS_PREVIEW_SOURCE_TO_STAGE_PATHS: dict[Path, Path] = {
  Path("py_modules/backend/__init__.py"): Path("py_modules/backend/__init__.py"),
  Path("py_modules/backend/diagnostics.py"): Path("py_modules/backend/diagnostics.py"),
  Path("py_modules/backend/http.py"): Path("py_modules/backend/http.py"),
  Path("py_modules/backend/provider_config.py"): Path("py_modules/backend/provider_config.py"),
  Path("py_modules/backend/redaction.py"): Path("py_modules/backend/redaction.py"),
  Path("py_modules/backend/secrets.py"): Path("py_modules/backend/secrets.py"),
  Path("py_modules/backend/storage.py"): Path("py_modules/backend/storage.py"),
  Path("py_modules/backend/tls.py"): Path("py_modules/backend/tls.py"),
  Path("steamos_backend/__init__.py"): Path("steamos_backend/__init__.py"),
  Path("steamos_backend/cache.py"): Path("steamos_backend/cache.py"),
  Path("steamos_backend/dev_shell.py"): Path("steamos_backend/dev_shell.py"),
  Path("steamos_backend/local_launcher.py"): Path("steamos_backend/local_launcher.py"),
  Path("steamos_backend/local_server.py"): Path("steamos_backend/local_server.py"),
  Path("steamos_backend/paths.py"): Path("steamos_backend/paths.py"),
  Path("steamos_backend/steamos_doctor.py"): Path("steamos_backend/steamos_doctor.py"),
