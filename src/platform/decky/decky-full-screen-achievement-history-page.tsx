...
const FULLSCREEN_ACHIEVEMENT_HISTORY_TOP_PADDING = 42;

function getPageFrameStyle(): CSSProperties {
  return {
    padding: `calc(env(safe-area-inset-top, 0px) + ${FULLSCREEN_ACHIEVEMENT_HISTORY_TOP_PADDING}px) 12px calc(env(safe-area-inset-bottom, 0px) + ${FULLSCREEN_ACHIEVEMENT_HISTORY_PROGRESS_BOTTOM_SCROLL_PADDING}px)`,
